...
Also not very well documented.  There's [some confusion]() as to what should go into [nsswitch.conf](http://netbsd.gw.com/cgi-bin/man-cgi?nsswitch.conf+5+NetBSD-1.4.3), but fortunately [\@RadoslawKujawa](https://twitter.com/RadoslawKujawa) cuts through the crap.  
